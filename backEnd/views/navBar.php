...
<body>
    <nav>
        ...
        <a href="/backEnd/usuario/membros.php">
        ...
        <a href="/backEnd/usuario/perfil.php">
            ...
            ?>
                    <img src="/uploads/usuario/<?= $img ?>" alt="" style="width: 25px; height: 25px; object-fit: cover;"><span>Perfil</span>
            <?php
                else:
            ?>
                    <img src="/uploads/usuario/placeholder.webp" alt="" style="width: 25px; height: 25px; object-fit: cover;"><span>Perfil</span>
            <?php
                endif;
            ?>
        </a>
        <a href="/backEnd/usuario/configuracoes.php">
        ...
        <?php if (($_SESSION['usuario_tipo'] ?? 0) == 1): ?>
            ...
            <a href="/backEnd/admin/denuncias.php"><span>Ver Denúncias</span></a>
            <a href="/backEnd/admin/estatisticas.php"><span>Estatísticas</span></a>
        <?php endif; ?>
    </nav>
